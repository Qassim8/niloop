...
export default function Contact() {
  return (
    <section
      className="h-screen overflow-hidden bg-cover bg-[url('/images/pattern 2.svg')] relative 
      before:absolute before:top-0 before:left-0 before:w-full before:h-full before:bg-white/80 before:z-20"
    >
