  ...
  return (
    <section className="py-20 bg-white">
      <div className="container mx-auto px-6 md:px-0">
        <SectionHeader title="الاعمال" subtitle="الق نظرة على اعمالنا" />
        ...
        <div className="text-center mt-12">
          <Link
            href="/works"
            className="px-6 py-3 bg-alt text-main font-bold rounded-2xl hover:!bg-blue-800 transition duration-300"
          >
            المزيد
          </Link>
        </div>
